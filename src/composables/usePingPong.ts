...
async function makeVmQuery(funcName: string, args: string[]): Promise<PingPongResponseType> {
  ...
  const response = await fetch(`${networkConfig.network.apiAddress}/vm-values/query`, {
    method: 'POST',
    headers: {
